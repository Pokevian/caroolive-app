...
public class GetRankingDialogFragment extends DialogFragment implements AlertDialogCallbacks {

    public static final String TAG = "GetRankingDialogFragment";
    ...
    public static GetRankingDialogFragment newInstance(String memberNo) {
        GetRankingDialogFragment fragment = new GetRankingDialogFragment();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            memberNo = getArguments().getString("memberNo");
            request();
        }
    }
        ...
        if ("load-failure-dialog".equals(tag)) {
            if (which == DialogInterface.BUTTON_POSITIVE) {
               request();
                ...
                mCallback.onFailure(GetRankingDialogFragment.this);
                dismiss();
            }
        }
    }
    ...
    private void request() {
        GetRankingRequest request = new GetRankingRequest(memberNo, new GetRankingListener());
        request.setTag(TAG);
    ...
    private class GetRankingListener extends VolleyListener<Rank[]> {
        ...
        public void onResponse(Rank[] response) {
            ...
            mCallback.onSuccess(GetRankingDialogFragment.this, response != null && response.length > 0 ? response[0] : null);
