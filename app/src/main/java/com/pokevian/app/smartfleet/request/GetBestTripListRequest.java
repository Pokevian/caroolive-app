...
public class GetBestTripListRequest extends GsonRequest<MemberEcoData[]> {

    public GetBestTripListRequest(String yyyyMMdd, String period, String limit, final VolleyListener<MemberEcoData[]> listener) {
        super(ServerUrl.GET_RANKING_BEST_TRIP_LIST_API, MemberEcoData[].class, listener);
