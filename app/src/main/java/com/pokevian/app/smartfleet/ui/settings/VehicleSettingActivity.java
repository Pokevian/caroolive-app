...
import com.pokevian.app.smartfleet.ui.setup.RegisterVehicleFragment;
import com.pokevian.app.smartfleet.ui.setup.RegisterVehicleFragment.RegisterVehicleCallbacks;

public class VehicleSettingActivity extends BaseActivity
        implements OnBackStackChangedListener, RegisterVehicleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            Fragment fragment = RegisterVehicleFragment.newInstance();
            fm.beginTransaction().replace(R.id.container, fragment, RegisterVehicleFragment.TAG)
                    .commit();
        }
    ...
    public void onBackStackChanged() {
        ...
        if (count == 0) {
            ...
            Fragment fragment = fm.findFragmentByTag(RegisterVehicleFragment.TAG);
    ...
    public void onBackPressed() {
        ...
        if (fm.getBackStackEntryCount() > 0) {
            ...
            RegisterVehicleFragment fragment = (RegisterVehicleFragment) fm.findFragmentByTag(RegisterVehicleFragment.TAG);
            if (fragment != null) {
            ...
            return new AlertDialog.Builder(getActivity())
                    ...
                    .setPositiveButton(R.string.btn_ok, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ((VehicleSettingActivity) getActivity()).onSetupSucceeded();
                        }
                    })
                    .show();
        }
