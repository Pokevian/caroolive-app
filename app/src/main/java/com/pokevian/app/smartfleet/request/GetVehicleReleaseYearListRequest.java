...
public class GetVehicleReleaseYearListRequest extends GsonRequest<SmartCarModelList> {

    public GetVehicleReleaseYearListRequest(String makerCode, String modelCode, String fuelCode, int displacement,
                                            final VolleyListener<VehicleModelList> listener) {
        ...
        searchParam.setCarModelNameCd(modelCode);
        searchParam.setCarSrcCd(fuelCode);
        searchParam.setEngineDisplacement(displacement);
        searchParam.setTargetField(TargetField.ReleaseYear);
