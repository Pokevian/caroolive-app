...
public class UpdateVehicleDialogFragment extends DialogFragment implements AlertDialogCallbacks {

    public static final String TAG = "UpdateVehicleDialogFragment";
    ...
    public static UpdateVehicleDialogFragment newInstance(String accountId, Vehicle vehicle) {
        UpdateVehicleDialogFragment fragment = new UpdateVehicleDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setMessage(getString(R.string.dialog_message_updating_odometer));
        setCancelable(false);
        return dialog;
    }
    ...
    public void onDialogButtonClick(DialogFragment fragment, int which) {
        ...
        if ("update-vehicle-failure-dialog".equals(tag)) {
            if (which == DialogInterface.BUTTON_POSITIVE) {
                ...
                mCallbacks.onUpdateOdometerFailure(UpdateVehicleDialogFragment.this, mVehicle);
                dismiss();
            }
        }
    }
    ...
    private class UpdateVehicleListener extends VolleyListener<Void> {
        ...
        public void onResponse(Void unused) {
            mCallbacks.onUpdateOdometerSuccess(UpdateVehicleDialogFragment.this, mVehicle);
            dismiss();
        }
    ...
    public interface UpdateVehicleCallbacks {
        void onUpdateOdometerSuccess(DialogFragment fragment, Vehicle vehicle);

        void onUpdateOdometerFailure(DialogFragment fragment, Vehicle vehicle);
    }
