...
public class GetVehicleTypeListRequest extends GsonRequest<SmartCarModelList> {

    public GetVehicleTypeListRequest(String makerCode, final VolleyListener<VehicleModelList> listener) {
        ...
        searchParam.setTargetField(TargetField.CarTypeCd);
