...
public class GetVehicleDisplacementListRequest extends GsonRequest<SmartCarModelList> {

    public GetVehicleDisplacementListRequest(String makerCode, String modelCode, String fuelCode,
        ...
        searchParam.setTargetField(TargetField.EngineDisplacement);
