...
public class GetVehicleFuelListRequest extends GsonRequest<SmartCarModelList> {

    public GetVehicleFuelListRequest(String makerCode, String modelCode,
        ...
        searchParam.setTargetField(TargetField.CarSrcCd);
