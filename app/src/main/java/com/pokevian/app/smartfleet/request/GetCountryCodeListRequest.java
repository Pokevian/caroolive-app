...
import com.pokevian.caroo.common.model.code.CodeUtils;
import com.pokevian.caroo.common.model.code.CountryCd;
...
public class GetCountryCodeListRequest extends GsonRequest<SmartCodeList> {

    public GetCountryCodeListRequest(final VolleyListener<CodeList> listener) {
        ...
        data.setGrpCd(CodeUtils.getGrpCodeName(CountryCd.class));
