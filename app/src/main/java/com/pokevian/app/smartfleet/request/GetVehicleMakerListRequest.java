...
public class GetVehicleMakerListRequest extends GsonRequest<SmartCarModelList> {

    public GetVehicleMakerListRequest(final VolleyListener<VehicleModelList> listener) {
        ...
        searchParam.setTargetField(TargetField.CarMakerCd);
